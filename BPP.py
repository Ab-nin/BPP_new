...
def load_models():
    ...
    data_d = pd.read_excel("dados_biodiesel_densidade.xlsx")
    ...
    data_hhv = pd.read_excel("dados_biodiesel_HHV.xlsx")
    ...
    data_os = pd.read_excel("dados_biodiesel_OS.xlsx")
    ...
    data_iv = pd.read_excel("dados_biodiesel_IV.xlsx")
    ...
    data_fscl = pd.read_excel("dados_biodiesel_LCSF.xlsx")
    ...
    data_cfpp = pd.read_excel("dados_biodiesel_CFPP.xlsx")
    ...
    data_sv = pd.read_excel("dados_biodiesel_SV.xlsx")
    ...
    data_lhv = pd.read_excel("dados_biodiesel_LHV(I).xlsx")
    ...
    data_v = pd.read_excel("dados_biodiesel_viscosidade.xlsx")
